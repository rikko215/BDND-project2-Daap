...
it('lets 2 users exchange stars', async() => {
    ...
    let user2 = accounts[2];
    let instance = await StarNotary.deployed();
    await instance.createStar('Awesome Star Test7', starId1, {from: user1});
    await instance.createStar('Awesome Star Test8', starId2, {from: user2});
...
it('lets a user transfer a star', async() => {
    ...
    let user2 = accounts[2];
    let instance = await StarNotary.deployed();
    await instance.createStar('Awesome Star Test9', starId, {from: user1});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let starId = 10;
    let instance = await StarNotary.deployed();
    await instance.createStar('Awesome Star Test10', starId, {from: accounts[0]});
    // 2. Call your method lookUptokenIdToStarInfo
    // 3. Verify if your Star name is the same
    assert.equal(await instance.lookUptokenIdToStarInfo.call(starId),'Awesome Star Test10');
});